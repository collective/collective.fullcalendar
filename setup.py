# -*- coding: utf-8 -*-
"""Installer for the collective.fullcalendar package."""
...
setup(
    ...
    project_urls={
        ...
        # 'Documentation': 'https://collective.fullcalendar.readthedocs.io/en/latest/',
    },
    ...
    target = plone
    [console_scripts]
    update_locale = collective.fullcalendar.locales.update:update_locale
    """,
)
